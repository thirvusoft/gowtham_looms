...
# Core code changes for auto reorder level - Start
	def add_to_material_request(
		item_code, warehouse, reorder_level, reorder_qty, max_qty, material_request_type, warehouse_group=None
	):
		...
		if (reorder_level or reorder_qty) and projected_qty < reorder_level:
			...
			deficiency = max_qty - projected_qty
...
# Core code changes for auto reorder level - End
